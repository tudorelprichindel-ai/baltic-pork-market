...
const PRODUCT_PRICE_MAP = {
  "Pork Neck": { category: "Pork", price: 7.9, unit: "kg" },
  "Pork Shoulder": { category: "Pork", price: 6.9, unit: "kg" },
  "Pork Belly": { category: "Pork", price: 7.5, unit: "kg" },
  "Pork Ribs": { category: "Pork", price: 7.2, unit: "kg" },
  "Pork Loin": { category: "Pork", price: 8.5, unit: "kg" },
  "Minced Pork": { category: "Pork", price: 6.5, unit: "kg" },

  "Beef Steak Cuts": { category: "Beef", price: 16.9, unit: "kg" },
  "Beef Ribs": { category: "Beef", price: 10.9, unit: "kg" },
  "Minced Beef": { category: "Beef", price: 8.9, unit: "kg" },
  "Beef Stew Meat": { category: "Beef", price: 9.5, unit: "kg" },
  "Beef Roast": { category: "Beef", price: 12.9, unit: "kg" },
  "Beef Burger Patties": { category: "Beef / BBQ", price: 10.9, unit: "kg" },

  "Lamb Leg": { category: "Lamb", price: 14.9, unit: "kg" },
  "Lamb Shoulder": { category: "Lamb", price: 12.9, unit: "kg" },
  "Lamb Chops": { category: "Lamb", price: 18.9, unit: "kg" },
  "Lamb Ribs": { category: "Lamb", price: 11.9, unit: "kg" },
  "Minced Lamb": { category: "Lamb", price: 12.5, unit: "kg" },
  "Lamb Stew Meat": { category: "Lamb", price: 11.9, unit: "kg" },

  "Chicken Breast": { category: "Chicken", price: 6.9, unit: "kg" },
  "Chicken Thighs": { category: "Chicken", price: 4.8, unit: "kg" },
  "Chicken Wings": { category: "Chicken", price: 4.2, unit: "kg" },
  "Chicken Drumsticks": { category: "Chicken", price: 4.5, unit: "kg" },
  "Whole Chicken": { category: "Chicken", price: 4.3, unit: "kg" },
  "Marinated Chicken": { category: "Chicken", price: 6.2, unit: "kg" },

  "Marinated Pork Neck": { category: "BBQ & Grill", price: 8.5, unit: "kg" },
  "BBQ Ribs": { category: "BBQ & Grill", price: 8.9, unit: "kg" },
  "Chicken Skewers": { category: "BBQ & Grill", price: 7.2, unit: "kg" },
  "Lamb Skewers": { category: "BBQ & Grill", price: 14.5, unit: "kg" },
  "Grill Sausages": { category: "BBQ & Grill", price: 7.9, unit: "kg" },

  "Smoked Bacon": { category: "Smoked Products", price: 9.9, unit: "kg" },
  "Smoked Pork Ribs": { category: "Smoked Products", price: 9.5, unit: "kg" },
  "Smoked Sausages": { category: "Smoked Products", price: 8.9, unit: "kg" },
  "Smoked Pork Loin": { category: "Smoked Products", price: 11.9, unit: "kg" },

  "Family Meat Box": { category: "Meat Boxes", price: 55, unit: "box" },
  "BBQ Box": { category: "Meat Boxes", price: 49, unit: "box" },
  "Pork Box": { category: "Meat Boxes", price: 39, unit: "box" },
  "Beef Box": { category: "Meat Boxes", price: 55, unit: "box" },
  "Lamb Box": { category: "Meat Boxes", price: 59, unit: "box" },
  "Chicken Box": { category: "Meat Boxes", price: 32, unit: "box" }
};
